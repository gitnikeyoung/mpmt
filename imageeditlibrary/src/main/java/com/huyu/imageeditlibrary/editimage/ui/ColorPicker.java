...
public class ColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
    ...
    public ColorPicker(Activity a, int r, int g, int b, AddTextFragment addTextFragment) {
        super(a);
        atf = addTextFragment;
        this.c = a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setContentView(R.layout.materialcolorpicker__layout_color_picker1);
        } else {
            setContentView(R.layout.materialcolorpicker__layout_color_picker_old_android);
        }

        colorView = findViewById(R.id.colorView);
        nowcolor = findViewById(R.id.nowcolor);
...
//                });
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        nowcolor.setBackgroundColor(Color.rgb(red, green, blue));
        atf.changeTextColor(Color.rgb(red, green, blue));
