...
import com.huyu.imageeditlibrary.editimage.adapter.ColorListAdapter;
import com.huyu.imageeditlibrary.editimage.task.StickerTask;
import com.huyu.imageeditlibrary.editimage.ui.ColorPicker1;
import com.huyu.imageeditlibrary.editimage.view.CustomPaintView;
import com.huyu.imageeditlibrary.editimage.view.PaintModeView;
...
public class PaintFragment extends BaseEditFragment implements View.OnClickListener, ColorListAdapter.IColorListAction {
    ...
    private FrameLayout pickerWrapper;
    private CustomPaintView mPaintView;

    private ColorPicker1 mColorPicker;//颜色选择器
    ...
    public int[] mPaintColors = {Color.DKGRAY, Color.GRAY, Color.LTGRAY,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pickerWrapper = mainView.findViewById(R.id.picker_wrapper);
        return mainView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mColorPicker = new ColorPicker1(getActivity(), 255, 0, 0,this);
        initColorListView();
        ...
        updateEraserView();
        replaceFragment(R.id.picker_wrapper,mColorPicker);
    }
...
//        });
    ...
    public void colorPickerShow(){
        if (pickerWrapper.getVisibility()==View.GONE){
            pickerWrapper.setVisibility(View.VISIBLE);
        }else {
            pickerWrapper.setVisibility(View.GONE);
        }
    }
    public void colorPickerHide(){
     ...
     * @param paintColor
     */
    public void setPaintColor(final int paintColor) {
