...
public class BeautyFragment extends BaseEditFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mbtxt = mainView.findViewById(R.id.mb_txt);
        mytxt = mainView.findViewById(R.id.my_txt);
        return mainView;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (seekBar.equals(mSmoothValueBar)){
            mytxt.setText(progress+"");
        }
        if (seekBar.equals(mWhiteValueBar)){
            mbtxt.setText(progress+"");
        }
    }
